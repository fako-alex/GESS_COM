...
<html lang="fr" dir="ltr">
    <head>
        ...
        <script defer="" src="{{asset('template/assets/js/tippy-bundle.umd.min.js') }} "></script>
        <script defer="" src="{{asset('template/assets/js/sweetalert.min.js') }} "></script>
    </head>
    ...
    <body x-data="main" class="relative overflow-x-hidden font-nunito text-sm font-normal antialiased" :class="[ $store.app.sidebar ? 'toggle-sidebar' : '', $store.app.theme === 'dark' || $store.app.isDarkMode ?  'dark' : '', $store.app.menu, $store.app.layout,$store.app.rtlClass]">
        ...
        <div class="main-container min-h-screen text-black">
            <!-- start main content section -->
            <div x-data="auth">
                <!-- <div class="absolute inset-0">
                    <img src="{{asset('template/assets/images/auth/bg-gradient.png') }}" alt="image" class="h-full w-full object-cover">
                </div> -->
                <div class="relative flex min-h-screen items-center justify-center bg-[url(../images/auth/map.png)] bg-cover bg-center bg-no-repeat px-6 py-10 sm:px-16">
                    <img src="{{asset('template/assets/images/auth/coming-soon-object1.png') }}" alt="image" class="absolute left-0 top-1/2 h-full max-h-[893px] -translate-y-1/2">
                    <img src="{{asset('template/assets/images/auth/coming-soon-object2.png') }}" alt="image" class="absolute left-24 top-0 h-40 md:left-[30%]">
                    <img src="{{asset('template/assets/images/auth/coming-soon-object3.png') }} " alt="image" class="absolute right-0 top-0 h-[30px]">
                    <img src="{{asset('template/assets/images/auth/polygon-object.svg') }}" alt="image" class="absolute bottom-0 end-[28%]">
                    <div class="relative flex w-full max-w-[1502px] flex-col justify-between overflow-hidden rounded-md bg-white/60 backdrop-blur-lg lg:min-h-[758px] lg:flex-row lg:gap-10 xl:gap-0">
                        <div class="relative hidden w-full items-center justify-center bg-[linear-gradient(225deg,rgba(239,18,98,1)_0%,rgba(67,97,238,1)_100%)] p-5 lg:inline-flex lg:max-w-[835px] xl:-ms-32 ltr:xl:skew-x-[14deg] rtl:xl:skew-x-[-14deg]">
                            ...
                            <div class="ltr:xl:-skew-x-[14deg] rtl:xl:skew-x-[14deg]">
                                <a href="javascript:0;" class="block w-48 lg:w-72 ms-10">
                                <img src="{{ asset('template/assets/images/logo-white.png') }}" alt="Logo" class="w-full rounded-full">
                                </a>
                                <div class="mt-24 hidden w-full max-w-[430px] lg:block">
                                    <img src="{{asset('template/assets/images/auth/login.svg') }}" alt="Cover Image" class="w-full">
                                </div>
                            </div>
                        </div>
                        <div class="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                            <div class="flex w-full max-w-[440px] items-center gap-2 lg:absolute lg:end-6 lg:top-6 lg:max-w-full">
                                <a href="javascript:0;" class="block w-8 lg:hidden">
                                    <img src="{{asset('template/ assets/images/logo.png') }}" alt="Logo" class="w-full">
                                </a>
                            </div>
                            <div class="w-full max-w-[200px] lg:mt-0">
                                <div class="mb-10">
                                    <h1 class="text-3xl font-extrabold uppercase !leading-snug text-primary md:text-4xl">Se connecter</h1>
                                    <p class="text-base font-bold leading-normal text-white-dark">Entrez votre email et votre mot de passe pour vous connecter</p>
                                </div>
                                <form class="space-y-5" method="POST" action="{{ route('login') }}">
                                    ...
                                    <!-- <x-auth-session-status class="mb-4" :status="session('status')" /> -->
                                        ...
                                        <div class="relative text-white-dark">
                                            <input id="email" name="email" required type="email" placeholder="Entrez votre e-mail" class="form-input ps-10 placeholder:text-white-dark">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative text-white-dark">
                                            <input id="password" name="password" required type="password" placeholder="Entrez le mot de passe" class="form-input ps-10 placeholder:text-white-dark">
                                    ...
                                    <div class="flex items-center justify-between">
                                        <label for="remember_me" class="flex cursor-pointer items-center">
                                            <input id="remember_me" type="checkbox" class="form-checkbox bg-white">
                                            <span class="text-white-dark">Se souvenir de moi</span>
                                        </label>
                                        <label class="text-end">
                                            <a href="{{ route('password.request') }}" class="uppercase text-primary underline transition hover:text-black">Mot de passe oubliez ?</a>
                                        </label>
                                    </div>
                                    <button type="submit" class="btn btn-gradient !mt-6 w-50 border-0 uppercase shadow-[0_10px_20px_-10px_rgba(67,97,238,0.44)]">
                                        Se connecter
                                    </button>
                                </form>
        ...
        <script>
        // Afficher un alert de test
        Swal.fire({
            title: 'Test réussi!',
            text: 'SweetAlert fonctionne dans ton projet.',
            icon: 'success',
