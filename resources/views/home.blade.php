...
<html lang="fr" dir="ltr">
    ...
    <body x-data="main" class="relative overflow-x-hidden text-sm antialiased font-normal font-nunito" :class="[ $store.app.sidebar ? 'toggle-sidebar' : '', $store.app.theme === 'dark' || $store.app.isDarkMode ?  'dark' : '', $store.app.menu, $store.app.layout,$store.app.rtlClass]">
        ...
        <div class="min-h-screen text-black main-container">
                                ...
                                <form class="space-y-5" method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="flex items-center justify-between">
                                        <label for="remember_me" class="flex items-center cursor-pointer">
                                            <input id="remember_me" type="checkbox" class="bg-white form-checkbox">
                                            <span class="text-white-dark">Se souvenir de moi</span>
                                        </label>
                                        <label class="text-end">
                                            <a href="{{ route('password.request') }}" class="underline uppercase transition text-primary hover:text-black">Mot de passe oubliez ?</a>
                                        </label>
                                    </div>
