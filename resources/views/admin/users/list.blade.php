...
<div class="animate__animated p-6" :class="[$store.app.animation]">
    ...
    <div x-data="contacts">
        <div class="flex flex-wrap items-center justify-between gap-4">
            <div class="flex flex-wrap items-center justify-between gap-4">
                <ol class="flex font-semibold text-primary dark:text-white-dark">
                    ...
                    <li class="bg-[#ebedf2] dark:bg-[#1b2e4b]">
                        <a
                            class="relative flex h-full items-center bg-primary p-1.5 text-white-light before:absolute before:inset-y-0 before:z-[1] before:m-auto before:h-0 before:w-0 before:border-[16px] before:border-l-[15px] before:border-r-0 before:border-t-transparent before:border-b-transparent before:border-l-primary ltr:pl-6 ltr:pr-2 ltr:before:-right-[15px] rtl:pr-6 rtl:pl-2 rtl:before:-left-[15px] rtl:before:rotate-180">Liste des utilisateurs</a>
                    </li>
                </ol>
            </div>
            <div class="flex w-full flex-col gap-4 sm:w-auto sm:flex-row sm:items-center sm:gap-3">
                <div class="flex gap-3">
                    ...
                    <div>
                        <button type="button" class="btn btn-outline-primary p-2 bg-primary text-white" :class="{ 'bg-primary text-white': displayType === 'list' }" @click="setDisplayType('list')">
        ...
        <div class="mb-5 mt-5 flex flex-wrap items-center " x-data="exportTable()" x-init="initTable()">
            ...
            <button type="button" class="btn btn-primary btn-sm m-1" @click="exportTable('excel')">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ltr:mr-2 rtl:ml-2">
                    <path d="M15.3929 4.05365L14.8912 4.61112L15.3929 4.05365ZM19.3517 7.61654L18.85 8.17402L19.3517 7.61654ZM21.654 10.1541L20.9689 10.4592V10.4592L21.654 10.1541ZM3.17157 20.8284L3.7019 20.2981H3.7019L3.17157 20.8284ZM20.8284 20.8284L20.2981 20.2981L20.2981 20.2981L20.8284 20.8284ZM14 21.25H10V22.75H14V21.25ZM2.75 14V10H1.25V14H2.75ZM21.25 13.5629V14H22.75V13.5629H21.25ZM14.8912 4.61112L18.85 8.17402L19.8534 7.05907L15.8947 3.49618L14.8912 4.61112ZM22.75 13.5629C22.75 11.8745 22.7651 10.8055 22.3391 9.84897L20.9689 10.4592C21.2349 11.0565 21.25 11.742 21.25 13.5629H22.75ZM18.85 8.17402C20.2034 9.3921 20.7029 9.86199 20.9689 10.4592L22.3391 9.84897C21.9131 8.89241 21.1084 8.18853 19.8534 7.05907L18.85 8.17402ZM10.0298 2.75C11.6116 2.75 12.2085 2.76158 12.7405 2.96573L13.2779 1.5653C12.4261 1.23842 11.498 1.25 10.0298 1.25V2.75ZM15.8947 3.49618C14.8087 2.51878 14.1297 1.89214 13.2779 1.5653L12.7405 2.96573C13.2727 3.16993 13.7215 3.55836 14.8912 4.61112L15.8947 3.49618ZM10 21.25C8.09318 21.25 6.73851 21.2484 5.71085 21.1102C4.70476 20.975 4.12511 20.7213 3.7019 20.2981L2.64124 21.3588C3.38961 22.1071 4.33855 22.4392 5.51098 22.5969C6.66182 22.7516 8.13558 22.75 10 22.75V21.25ZM1.25 14C1.25 15.8644 1.24841 17.3382 1.40313 18.489C1.56076 19.6614 1.89288 20.6104 2.64124 21.3588L3.7019 20.2981C3.27869 19.8749 3.02502 19.2952 2.88976 18.2892C2.75159 17.2615 2.75 15.9068 2.75 14H1.25ZM14 22.75C15.8644 22.75 17.3382 22.7516 18.489 22.5969C19.6614 22.4392 20.6104 22.1071 21.3588 21.3588L20.2981 20.2981C19.8749 20.7213 19.2952 20.975 18.2892 21.1102C17.2615 21.2484 15.9068 21.25 14 21.25V22.75ZM21.25 14C21.25 15.9068 21.2484 17.2615 21.1102 18.2892C20.975 19.2952 20.7213 19.8749 20.2981 20.2981L21.3588 21.3588C22.1071 20.6104 22.4392 19.6614 22.5969 18.489C22.7516 17.3382 22.75 15.8644 22.75 14H21.25ZM2.75 10C2.75 8.09318 2.75159 6.73851 2.88976 5.71085C3.02502 4.70476 3.27869 4.12511 3.7019 3.7019L2.64124 2.64124C1.89288 3.38961 1.56076 4.33855 1.40313 5.51098C1.24841 6.66182 1.25 8.13558 1.25 10H2.75ZM10.0298 1.25C8.15538 1.25 6.67442 1.24842 5.51887 1.40307C4.34232 1.56054 3.39019 1.8923 2.64124 2.64124L3.7019 3.7019C4.12453 3.27928 4.70596 3.02525 5.71785 2.88982C6.75075 2.75158 8.11311 2.75 10.0298 2.75V1.25Z" fill="currentColor"></path>
                    <path opacity="0.5" d="M13 2.5V5C13 7.35702 13 8.53553 13.7322 9.26777C14.4645 10 15.643 10 18 10H22" stroke="currentColor" stroke-width="1.5"></path>
        ...
        <div class="mt-5 overflow-hidden border-0 p-0">
                        ...
                        <tbody>
                            @forelse($users as $user)
                                <tr>
                                            ...
                                            <div class="flex-none mr-3">
                                                <div class="p-1 bg-white-dark/30 rounded-full">
                                                    @if ($user->profile_picture)
                                                        <img src="{{ asset('documents/users/' . $user->profile_picture)}}" alt="photo de profile" class="h-12 w-12 rounded-full object-cover">
                                                    @else
                                                        Pas d'images
                                                    @endif
                                                </div>
                                    ...
                                    <td>{{ $user->birth_date ?? 'Non défini' }}</td>{{-- A inverser --}}
                                    <td>{{ $user->birth_place ?? 'Non défini' }}</td>
                                    <td>{{ $user->address ?? 'Non défini' }}</td>
                                    <td>{{ $user->role ?? 'Non défini' }}</td> {{-- Ajouter un script pour afficher l'un ou l'autre --}}
                                    <td>{{ $user->class_level ?? 'Non défini' }}</td>
                                    <td>{{ $user->department ?? 'Non défini' }}</td>
                                    <td>{{ $user->registration_date ?? 'Non défini' }}</td>
                                    <td>{{ $user->addedByUser->name ?? 'Non défini' }}</td>
                                    ...
                                    <td class="text-center">
                                        <ul class="flex items-center justify-center gap-2">
                                            ...
                                            <div>
                                                <li>
                                                    <a onclick="confirmation(event)" href="{{ url('users/delete',$user->id)}}"  x-tooltip="Supprimer">
                                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                ...
                @forelse($users as $user)
                    <div class="relative overflow-hidden rounded-md bg-white text-center shadow dark:bg-[#1c232f]">
                        <div class="rounded-t-md bg-white/40 bg-[url('../images/notification-bg.png')] bg-cover bg-center p-6 pb-0">
                            <template>
                                <img class="mx-auto max-h-40 w-4/5 object-contain" src="assets/images/user-profile.jpeg">
                            </template>
                        </div>
                        <div class="relative -mt-10 px-6 pb-24">
                            <div class="rounded-md bg-white px-2 py-4 shadow-md dark:bg-gray-900">
                                <div class="mt-2 flex flex-wrap items-center gap-3">
                                    <div class="flex-auto">
                                        {{-- <img class="h-20 w-20 rounded-full object-cover" src="{{asset('template/assets/images/user-profile.jpeg')}}"> --}}
                                    </div>
                                    <div class="flex-center">
                                        @if ($user->profile_picture)
                                            <img src="{{ asset('documents/users/' . $user->profile_picture)}}" alt="photo de profile" class="h-20 w-20 object-cover">
                                        @else
                                            Pas d'images
                                        @endif
                                    </div>
                            ...
                            <div class="mt-3 grid grid-cols-1 gap-4 ltr:text-left rtl:text-right">
                        ...
                        <div class="absolute bottom-0 mt-2 flex w-full gap-4 p-6 ltr:left-0 rtl:right-0">
                            <a href="{{ route('admin.users/update',['id'=> $user->id]) }}" class="btn btn-outline-primary w-1/2">Modifier</a>
                            {{-- <button  type="button" class="btn btn-outline-primary w-1/2">Edit</button> --}}
                            <a onclick="confirmation(event)" href="{{ url('users/delete',$user->id)}}" class="btn btn-outline-danger w-1/2">
                                Supprimer
                            </a>
                            {{-- <button type="button" class="btn btn-outline-danger w-1/2">Delete</button> --}}
                        </div>
                    </div>
                @empty
                    <diiv class="text-center">
                        <h1 colspan="3">Pas d'utilisateurs</h1>
                    </diiv>
                @endforelse
            </div>
        </template>
