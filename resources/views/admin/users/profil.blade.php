                    ...
                    {{-- <div class="panel"> --}}
                        ...
                        <div class="mb-5">
                            <div class="flex flex-col items-center justify-center">
                                <img src="{{ asset('documents/users/' . $user->profile_picture)}}" alt="image" class="mb-5 h-24 w-24 rounded-full object-cover">
                            ...
                            <ul class="m-auto mt-5 flex max-w-[160px] flex-col space-y-4 font-semibold text-white-dark">
                                ...
                                <li class="flex items-center gap-2">
                                    ...
                                    {{ \Carbon\Carbon::parse($user->registration_date)->format('d/m/Y') }} à {{ \Carbon\Carbon::parse($user->registration_date)->format('H:i') }}
