                ...
                <div class="table-responsive">
                    <table id="myTable" class="table-striped table-hover">
                        <thead>
                            <tr>
                                <th>N°</th>
                                <th>Titre de la raison</th>
                                <th>Date de creation</th>
                                <th>Créer par</th>
                                <th>Description de la raison</th>
                        ...
                        <tbody>
                            @forelse($departures as $departure)
                                <tr>
                                    ...
                                    <td>{{ $departure->created_at ? \Carbon\Carbon::parse($departure->created_at)->format('d/m/Y') : ' ' }}</td>
                                    <td>{{ $departure->addedBydeparture ? $departure->addedBydeparture->name . ' ' . $departure->addedBydeparture->first_name : 'Non défini' }}</td>
                                    <td>{{ $departure->detail ?? 'Non défini'}}</td>
                                    <td class="text-center">
                                        <ul class="flex items-center justify-center gap-2">
                                            <div x-data="{ open: false, selectedType: '' }">
                                                <!-- Bouton Modifier avec modale -->
                                                <li>
                                                    <a href="{{ route('admin.departures.update',['id'=> $departure->id]) }}"x-tooltip="Modifier">
                                            ...
                                            <div>
                                                <li>
                                                    <a onclick="confirmation(event)" href="{{ route('admin.departures.delete', $departure->id) }}"  x-tooltip="Supprimer">
                                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
