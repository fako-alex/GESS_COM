              ...
              <div class="grid grid-cols-1 gap-6 mb-6 text-white sm:grid-cols-2 xl:grid-cols-4">
                  ...
                  <div class="panel bg-gradient-to-r from-cyan-500 to-cyan-400">
                      <div class="flex justify-between">
                          <div class="font-semibold text-md ltr:mr-1 rtl:ml-1">Users Visit</div>
                  ...
                  <div class="panel bg-gradient-to-r from-violet-500 to-violet-400">
                      <div class="flex justify-between">
                          <div class="font-semibold text-md ltr:mr-1 rtl:ml-1">Sessions</div>
                          <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                              <a href="javascript:;" @click="toggle">
                                  <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 opacity-70 hover:opacity-80">
                                      <circle cx="5" cy="12" r="2" stroke="currentColor" stroke-width="1.5"></circle>
                  ...
                  <div class="panel bg-gradient-to-r from-blue-500 to-blue-400">
                      <div class="flex justify-between">
                          <div class="font-semibold text-md ltr:mr-1 rtl:ml-1">Time On-Site</div>
                          <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                              <a href="javascript:;" @click="toggle">
                                  <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 opacity-70 hover:opacity-80">
                                      <circle cx="5" cy="12" r="2" stroke="currentColor" stroke-width="1.5"></circle>
                  ...
                  <div class="panel bg-gradient-to-r from-fuchsia-500 to-fuchsia-400">
                      <div class="flex justify-between">
                          <div class="font-semibold text-md ltr:mr-1 rtl:ml-1">Bounce Rate</div>
                          <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                              <a href="javascript:;" @click="toggle">
                                  <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 opacity-70 hover:opacity-80">
                                      <circle cx="5" cy="12" r="2" stroke="currentColor" stroke-width="1.5"></circle>
                              ...
                              <tbody>
                                  <tr>
                                      ...
                                      <td class="text-center">
                                          <span class="rounded-full badge bg-success/20 text-success hover:top-0">Completed</span>
                                      </td>
                                  </tr>
                                  <tr>
                                      ...
                                      <td>-$1,042.82</td>
                                      <td class="text-center">
                                          <span class="rounded-full badge bg-info/20 text-info hover:top-0">In Process</span>
                                      </td>
                                  </tr>
                                  <tr>
                                      ...
                                      <td>$1,828.16</td>
                                      <td class="text-center">
                                          <span class="rounded-full badge bg-danger/20 text-danger hover:top-0">Pending</span>
                                      </td>
                                  </tr>
                                  <tr>
