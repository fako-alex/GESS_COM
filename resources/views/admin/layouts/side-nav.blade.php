          ...
          <ul class="perfect-scrollbar relative h-[calc(100vh-80px)] space-y-0.5 overflow-y-auto overflow-x-hidden p-4 py-0 font-semibold" x-data="{ activeDropdown: 'dashboard' }">
              ...
              <li class="nav-item">
               ...
               {{-- start personnel --}}
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{'active' : activeDropdown === 'personnel'}" @click="activeDropdown === 'personnel' ? activeDropdown = null : activeDropdown = 'personnel'">
                        <div class="flex items-center">
                            <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle opacity="0.5" cx="15" cy="6" r="3" fill="currentColor"></circle>
                                <ellipse opacity="0.5" cx="16" cy="17" rx="5" ry="3" fill="currentColor"></ellipse>
                            ...
                            <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Personnel</span>
                        </div>
                    ...
                    <ul x-cloak="" x-show="activeDropdown === 'personnel'" x-collapse="" class="text-gray-500 sub-menu">
                        ...
                        <li x-data="{subActive:null}">
                            <button type="button" class="before:h-[5px] before:w-[5px] before:rounund before:bg-gray-300 hover:bg-gray-100 ltr:before:mr-2 rtl:before:ml-2 dark:text-[#888ea8] dark:hover:bg-gray-900" @click="subActive === 'paramettre' ? subActive = null : subActive = 'paramettre'">
                                Paramètres personnel
                                <div class="ltr:ml-auto rtl:mr-auto rtl:rotate-180" :class="{'!rotate-90' : subActive === 'paramettre'}">
                            ...
                            <ul class="text-gray-500 sub-menu ltr:ml-2 rtl:mr-2" x-show="subActive === 'paramettre'" x-collapse="">
                                <li>
                                    <a href="{{url('services/list')}}">Services</a>
                                </li>
                                <li>
                                    <a href="{{url('departures/create')}}">Motif de départ</a>
                                </li>
                            </ul>
                        </li>
                        {{-- <li>
            ...
            <li class="menu nav-item">
                <button type="button" class="nav-link group" :class="{'active' : activeDropdown === 'planning'}" @click="activeDropdown === 'planning' ? activeDropdown = null : activeDropdown = 'planning'">
                    <div class="flex items-center">
                        ...
                        <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Planning</span>
                    </div>
