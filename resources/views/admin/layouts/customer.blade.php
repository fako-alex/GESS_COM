...
<nav class="fixed bottom-0 top-0 z-[51] w-full max-w-[400px] bg-white p-4 shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] transition-[right] duration-300 ltr:-right-[400px] rtl:-left-[400px] dark:bg-[#0e1726]"
    ...
    <a href="javascript:;"
        class="absolute top-0 bottom-0 flex items-center justify-center w-12 h-10 my-auto text-white cursor-pointer bg-primary ltr:-left-12 ltr:rounded-bl-full ltr:rounded-tl-full rtl:-right-12 rtl:rounded-br-full rtl:rounded-tr-full"
    ...
    <div class="h-full overflow-x-hidden overflow-y-auto perfect-scrollbar">
        <div class="relative pb-5 text-center">
            ...
            <h4 class="mb-1 dark:text-white">{{ config('app.name') }}</h4>
            <p class="text-white-dark">Définissez les préférences qui seront enregistrées pour votre démonstration
                d'aperçu en direct.</p>
        </div>
        <div class="mb-3 rounded-md border border-dashed border-[#e0e6ed] p-3 dark:border-[#1b2e4b]">
            <h5 class="mb-1 text-base leading-none dark:text-white">Schéma de couleurs</h5>
            <p class="text-xs text-white-dark">Présentation générale claire ou foncée.</p>
        ...
        <div class="mb-3 rounded-md border border-dashed border-[#e0e6ed] p-3 dark:border-[#1b2e4b]">
            <h5 class="mb-1 text-base leading-none dark:text-white">Position de navigation</h5>
            <p class="text-xs text-white-dark">Sélectionnez le paradigme de navigation principal pour votre
                application.</p>
            <div class="grid grid-cols-3 gap-2 mt-3">
                <button type="button" class="btn"
            ...
            <div class="mt-5 text-primary">
                <label class="inline-flex mb-0">
                    ...
                    <span>Semi-foncé (barre latérale et en-tête)</span>
                </label>
            </div>
        </div>
        <div class="mb-3 rounded-md border border-dashed border-[#e0e6ed] p-3 dark:border-[#1b2e4b]">
            <h5 class="mb-1 text-base leading-none dark:text-white">Style de mise en page</h5>
            <p class="text-xs text-white-dark">Sélectionnez le style de mise en page principal pour votre application.
            </p>
        ...
        <div class="mb-3 rounded-md border border-dashed border-[#e0e6ed] p-3 dark:border-[#1b2e4b]">
            ...
            <p class="text-xs text-white-dark">Sélectionnez la direction de votre application.</p>
            <div class="flex gap-2 mt-3">
                <button type="button" class="flex-auto btn"
        ...
        <div class="mb-3 rounded-md border border-dashed border-[#e0e6ed] p-3 dark:border-[#1b2e4b]">
            <h5 class="mb-1 text-base leading-none dark:text-white">Type de barre de navigation</h5>
            <p class="text-xs text-white-dark">Collant ou flottant.</p>
