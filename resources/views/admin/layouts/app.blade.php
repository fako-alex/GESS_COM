...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('template/favicon.png') }} ">
...
<body x-data="main" class="relative overflow-x-hidden text-sm antialiased font-normal font-nunito"
    ...
    {{-- Ajout de suite Alert --}}
    @include('sweetalert::alert')
    {{-- fin Ajout de suite Alert --}}
    ...
    <script defer="" src="{{ asset('template/assets/js/apexcharts.js') }}"></script>
    <script>
        document.addEventListener('alpine:init', () => {
            ...
            Alpine.data('header', () => ({
                ...
                notifications: [{
                        ...
                        message: '<strong class="mr-1 text-sm">StarCode Kh</strong>invite you to <strong>Prototyping</strong>',
                        time: '45 min ago',
                    },
                    {
                        id: 2,
                ...
                get dailySalesOptions() {
                    return {
                        ...
                        xaxis: {
                            ...
                            genres: ['Sun', 'Mon', 'Tue', 'Wed', 'Thur', 'Fri', 'Sat'],
                        },
                        yaxis: {
                            show: false,
                        },
    ...
    {{-- Data table --}}
    <script src="{{ asset('template/assets/js/highlight.min.js') }}"></script>
