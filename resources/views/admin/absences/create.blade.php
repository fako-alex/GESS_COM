...
<form method="post" action="{{ route('admin.absences.save') }}" class="mb-5 rounded-md border border-[#ebedf2] bg-white p-4 dark:border-[#191e3a] dark:bg-[#0e1726]">
    @csrf
    <div class="panel">
        <div class="flex items-center justify-between mb-5">
            <h5 class="text-lg font-semibold dark:text-white-light">Ajouter une raison d'absence</h5>
        </div>
        <div class="mb-5">
    ...
    <div class="grid grid-cols-3 gap-5">
        <div class="col-span-1">
            <label for="name">Raison d'absence <span class="text-danger">*</span></label>
        ...
        <div class="col-span-2">
            <label for="detail">Description de la raison d'absence <span class="text-danger"></span></label>
