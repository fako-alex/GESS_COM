...
@section('content')
    <form method="post" action="{{ route('admin.planning.save') }}"
        class="mb-5 rounded-md border border-[#ebedf2] bg-white p-4 dark:border-[#191e3a] dark:bg-[#0e1726]">
        @csrf
        <div class="panel">
            <div class="flex items-center justify-between mb-5">
                <h5 class="text-lg font-semibold dark:text-white-light">Ajout des plannings</h5>
            </div>
        ...
        <div class="grid flex-auto grid-cols-2 gap-5 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xxl:grid-cols-5">
            <div class="col-span-1">
                ...
                <input id="name_model_planning" name="name_model_planning" value="{{ old('name_model_planning') }}"
            ...
            <div class="col-span-1">
                ...
                <select id="type_model_planning" name="type_model_planning" class="w-full form-select" required>
                    ...
                    <option value="flex_1" {{ old('type_model_planning') == 'flex_1' ? 'selected' : '' }}>Flex 1 Plage
                    </option>
                    <option value="flex_2" {{ old('type_model_planning') == 'flex_2' ? 'selected' : '' }}>Flex 2 Plages
                    </option>
                </select>
            ...
            <div class="col-span-1">
                ...
                <input id="duree_calculer_model_planning" name="duree_calculer_model_planning"
                    value="{{ old('duree_calculer_model_planning') }}" type="text" placeholder="Ex : 08:30 de travail"
                    class="w-full text-gray-800 bg-gray-200 form-input" oninput="validateHour(this)" maxlength="5"
                    readonly>
        ...
        <div id="section_2"
            ...
            <div class="col-span-1">
                ...
                <input id="heure_arriver_un_model_planning" name="heure_arriver_un_model_planning"
                    value="{{ old('heure_arriver_un_model_planning') }}" type="text" placeholder="Ex : 12:30"
                    class="w-full form-input" oninput="validateHour(this)" maxlength="5">
            ...
            <div class="col-span-1">
                ...
                <input id="heure_depart_un_model_planning" name="heure_depart_un_model_planning"
                    value="{{ old('heure_depart_un_model_planning') }}" type="text" placeholder="Ex : 12:30"
                    class="w-full form-input" oninput="validateHour(this)" maxlength="5">
                <small class="text-gray-500">Format : HH:MM (00:00 à 23:59)</small>
            ...
            <div class="col-span-1">
                ...
                <input id="av_dep_un" name="av_dep_un" value="{{ old('av_dep_un') }}" type="text"
            ...
            <div class="col-span-1">
                ...
                <input id="ap_dep_un" name="ap_dep_un" value="{{ old('ap_dep_un') }}" type="text"
                    placeholder="Exp : OFT" class="w-full form-input">
            ...
            <div class="col-span-1">
                <label for="debut_ap_un">A partir de</label>
                <input id="debut_ap_un" name="debut_ap_un" value="{{ old('debut_ap_un') }}" type="text"
                    placeholder="Ex : 12:30" class="w-full form-input" oninput="validateHour(this)" maxlength="5">
                <small class="text-gray-500">Format : HH:MM (00:00 à 23:59)</small>
            ...
            <div class="col-span-1">
                ...
                <input id="fin_ap_un" name="fin_ap_un" value="{{ old('fin_ap_un') }}" type="text"
                    placeholder="Ex : 12:30" class="w-full form-input" oninput="validateHour(this)" maxlength="5">
                <small class="text-gray-500">Format : HH:MM (00:00 à 23:59)</small>
            ...
            <div class="hidden col-span-1 extra_section">
                ...
                <input id="heure_arriver_deux_model_planning" name="heure_arriver_deux_model_planning"
                    value="{{ old('heure_arriver_deux_model_planning') }}" type="text" placeholder="Ex : 12:30"
                    class="w-full form-input" oninput="validateHour(this)" maxlength="5">
                <small class="text-gray-500">Format : HH:MM (00:00 à 23:59)</small>
            ...
            <div class="hidden col-span-1 extra_section">
                ...
                <input id="heure_depart_deux_model_planning" name="heure_depart_deux_model_planning"
                    value="{{ old('heure_depart_deux_model_planning') }}" type="text" placeholder="Ex : 12:30"
                    class="w-full form-input" oninput="validateHour(this)" maxlength="5">
                <small class="text-gray-500">Format : HH:MM (00:00 à 23:59)</small>
            ...
            <div class="hidden col-span-1 extra_section">
                ...
                <input id="av_dep_deux" name="av_dep_deux" value="{{ old('av_dep_deux') }}" type="text"
                    placeholder="Exp : OFT" class="w-full form-input">
            ...
            <div class="hidden col-span-1 extra_section">
                ...
                <input id="ap_dep_deux" name="ap_dep_deux" value="{{ old('ap_dep_deux') }}" type="text"
                    placeholder="Exp : OFT" class="w-full form-input">
            ...
            <div class="hidden col-span-1 extra_section">
                <label for="debut_ap_deux">A partir de</label>
                <input id="debut_ap_deux" name="debut_ap_deux" value="{{ old('debut_ap_deux') }}" type="text"
                    placeholder="Ex : 12:30" class="w-full form-input" oninput="validateHour(this)" maxlength="5">
                <small class="text-gray-500">Format : HH:MM (00:00 à 23:59)</small>
            ...
            <div class="hidden col-span-1 extra_section">
                ...
                <input id="fin_ap_deux" name="fin_ap_deux" value="{{ old('fin_ap_deux') }}" type="text"
                    placeholder="Ex : 12:30" class="w-full form-input" oninput="validateHour(this)" maxlength="5">
                <small class="text-gray-500">Format : HH:MM (00:00 à 23:59)</small>
